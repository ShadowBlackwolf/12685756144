...
class CfgSpawnPoints {
    ...
    class Altis {
        ...
        class Cop {
            class Kavala {
                displayName = "Stuetzpunkt Kavala";
            ...
            class Athira {
                displayName = "Stuetzpunkt Athira";
            ...
            class Pyrgos {
                displayName = "Stuetzpunkt Pyrgos";
            ...
            class HW {
                displayName = "Stuetzpunkt 2";
                spawnMarker = "cop_spawn_5";
                icon = "\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa";
                conditions = "call life_coplevel >= 3";
            };
			class SP {
                displayName = "Stuetzpunkt 1";
